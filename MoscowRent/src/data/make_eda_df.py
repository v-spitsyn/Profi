...
PROJECT_FOLDER_PATH = 'C:/Users/Arenter/Documents/Python Scripts/rent/Avito'
...
def bind_df() -> pd.DataFrame:
    flats_paths = glob.glob(FLATS_FOLDER_PATH + '/flats_*.pickle')
